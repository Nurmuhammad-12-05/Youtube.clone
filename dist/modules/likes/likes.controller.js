...
const comment_leki_1 = require("./dto/comment.leki");
let LikesController = class LikesController {
    likesService;
    constructor(likesService) {
        this.likesService = likesService;
    }
    async likeComment(commentId, dto, req) {
        const userId = req['userId'];
        return this.likesService.likeComment(commentId, dto.type, userId);
    }
    async removeCommentLike(commentId, req) {
        const userId = req['userId'];
...
__decorate([
    ...
    __metadata("design:paramtypes", [String, comment_leki_1.CommentLikeDto, Object]),
    __metadata("design:returntype", Promise)
], LikesController.prototype, "likeComment", null);
__decorate([
    (0, common_1.Delete)('/comments/:id/like'),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Req)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Object]),
    __metadata("design:returntype", Promise)
], LikesController.prototype, "removeCommentLike", null);
